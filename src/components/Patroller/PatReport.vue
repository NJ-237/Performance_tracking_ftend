<template>
  ...
  color: black;" class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="logo">
                <img src="C:\projects\cimencam_app\frontend\Performance_tracking_ftend\cimencam_ft\src\assets\img\10_48_34_cimencam_logo.png" alt="" srcset="">
                <span>Dashboard</span>
            </div>
        </div>
        <ul class="nav-links">
                                        ...
                                        <div class="form-sections">
                                            <div class="form-section">
                                                ...
                                                <div class="checkbox-group">
                                                    <label><input type="checkbox"> Silo kk 1</label>
                                                    <label><input type="checkbox"> Silo kk 2</label>
                                                    <label><input type="checkbox"> Silo kk 3</label>
                                                    <label><input type="checkbox"> Silo kk 4</label>
                                                    <label><input type="checkbox"> Quai 029</label>
                                                    <label><input type="checkbox"> Hall</label>
                                                    <label><input type="checkbox"> Compteur Marche a vide</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-section">
                                                ...
                                                <div class="checkbox-group">
                                                    ...
                                                    <label><input type="checkbox"> Silo kk 3</label>
                                                    <label><input type="checkbox"> Silo kk 4</label>
                                                    <label><input type="checkbox"> Silo kk 5</label>
                                                    <label><input type="checkbox"> Silo kk 6</label>
                                                    <label><input type="checkbox"> Silo kk 7</label>
                                                    <label><input type="checkbox"> Silo kk 8</label>
                                                    <label><input type="checkbox"> Silo kk 9</label>
                                                    <label><input type="checkbox"> Silo kk 10</label>
                                                    <label><input type="checkbox"> Silo kk 11</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="report-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><span class="date-badge">Compteur Debut</span></td>
                                                    <td><input type="text" class="form-control" placeholder="Enter time"></td>
                                                    <td><input type="text" class="form-control" value="Quincy with fruits, plants, edible fruits"></td>
                                                    <td><input type="text" class="form-control" value="Sunny"></td>
                                                    <td><input type="text" class="form-control" value="Vegetation/water supply"></td>
                                                    <td><input type="text" class="form-control" value="Vegetation/water supply"></td>
                                                    <td><input type="text" class="form-control" value="Vegetation/water supply"></td>
                                                </tr>
                                                <tr>
                                                    <td><span class="date-badge">Compteur Fin</span></td>
                                                    <td><input type="text" class="form-control" placeholder="Enter time"></td>
                                                    <td><input type="text" class="form-control" placeholder="Activity"></td>
                                                    <td><input type="text" class="form-control" placeholder="Weather"></td>
                                                    <td><input type="text" class="form-control" placeholder="Vegetation/water supply"></td>
                                                    <td><input type="text" class="form-control" placeholder="Vegetation/water supply"></td>
                                                    <td><input type="text" class="form-control" placeholder="Vegetation/water supply"></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="report-body">
                                        ...
                                        <div class="form-sections">
                                            ...
                                            <div class="form-section">
                                                ...
                                                <div class="checkbox-group">
                                                    <label><input type="checkbox"> En Marche</label>
                                                    <label><input type="checkbox"> En Arret</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="report-body">
                                        ...
                                        <div class="form-sections">
                                            <div class="form-section">
                                                <h4 class="section-subtitle">Extraction Silo</h4>
                                                <div class="checkbox-group">
                                                    <label style="color: black;"><input type="checkbox"> Silo kk 1</label>
                                                    <label><input type="checkbox"> Silo kk 2</label>
                                                    <label><input type="checkbox"> Silo kk 3</label>
                                                    <label><input type="checkbox"> Silo kk 4</label>
                                                    <label><input type="checkbox"> Quai 029</label>
                        ...
                        <div id="carouselExampleIndicators6" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="report-body">
                                        <h3 class="section-title"><i class="fas fa-user me-2"></i>Expedition Report</h3>
