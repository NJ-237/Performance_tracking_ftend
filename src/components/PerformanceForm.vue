        ...
        <li>
          <router-link class="nav-link" to="/performance" active-class="active">
            ...
            <ul class="dropdown-menu">
              <li class="dropdown-menu-item"><router-link class="nav-link" to="/performance" >Dashboard 1</router-link></li>
              <li class="dropdown-menu-item"><router-link class="nav-link" to="/performance" >Dashboard 2</router-link></li>
              <li class="dropdown-menu-item"><router-link class="nav-link" to="/performance" >Dashboard 3</router-link></li>
            </ul>
        </li>
          <li>
